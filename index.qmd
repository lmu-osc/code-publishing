...
[Quarto](https://quarto.org/docs/download/release.html).
...
It is the successor of the R package [`rmarkdown`](https://pkgs.rstudio.com/rmarkdown/)
...
you can also create dynamic documents with the following tools:
