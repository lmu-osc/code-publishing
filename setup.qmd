...
If you are asked to install required packages, select _Yes_.
Also, if this is the first time you are hearing about `renv`,
...
You may need to confirm this `renv` command (and the ones to follow) by entering `Y`.
...
Open it to verify that it includes your name as author.
