...
which we will [cover later](make-readme.qmd)).
...
under [AGPLv3][agpl] (or later) or (at the option of the reuser) under [CC\ BY-SA\ 4.0][cc-by-sa],
...
After choosing a license, commit your changes:
...
flowchart TB
  ...
  facts --"No"--> choose-license["<em>Consult flowchart for<br>software, writing,<br>image, audio, and video</em>"]
  end
  
  subgraph database["<strong>License for database</strong>"]
  choose-license --> switch_license["<em>Depending on<br>content license</em>"]
